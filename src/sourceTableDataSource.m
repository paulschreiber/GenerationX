...
- (void) refreshWithGED: (GCFile*) g
{
	...
	[sourceMessageText setStringValue: [NSString stringWithFormat: @"%@ of %@ sources",
										[[NSNumber numberWithInteger: [displayedSources count]] stringValue],
										[[NSNumber numberWithInteger: [g numSources]] stringValue]]];
...
{
	NSInteger i = [displayedSources indexOfObject: s];
...
- (void) handleFilterSources: (id) sender
{
	...
	[sourceMessageText setStringValue: [NSString stringWithFormat: @"%@ of %@ sources",
										[[NSNumber numberWithInteger: [displayedSources count]] stringValue],
										[[NSNumber numberWithInteger: [[currentDoc ged] numSources]] stringValue]]];
